                         ...
                         (set (make-local-variable 'centaur-tabs-projectile-buffer-group-calc)
                              (cond
                               ...
                               ((or
                                 ...
                                 (string-prefix-p "stuff" (buffer-name))
...
** Agenda
   ...
   #+begin_src emacs-lisp
              ...
              ((tags-todo "TODO=\"IN-PROGRESS\""
               ...
               (tags "CATEGORY=\"inbox\""
                     ((org-agenda-overriding-header "Inbox")
                      (org-agenda-files '("/Users/kyang/org/agenda/inbox.org"))))
               (todo "NEXT"
     ...
     ;; how many days out to show deadlines for
   ...
   #+begin_src emacs-lisp
     ...
     (setq org-todo-keywords
           '((sequence "TODO(t)" "|" "DONE(d)" "N/A(a)") ;; small tasks
             (sequence "IDLE(l)" "NEXT(n)" "IN-PROGRESS(i!)" "REVIEWING(r!)" "|")
             ))
...
** Org-Journal
   ...
   #+begin_src emacs-lisp
     ...
     (use-package org-journal
       :custom
       (org-journal-dir "/Users/kyang/org/journal")
...
** Deft
   ...
   #+begin_src emacs-lisp
     (use-package deft
       :custom
       (deft-directory "/Users/kyang/org/notes")
       (deft-extensions '("org"))
