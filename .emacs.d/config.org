...
** Basic Settings
   ...
   #+begin_src emacs-lisp
     ...
     (defun ky/org-hide-done-entries-in-buffer()
       (interactive)
       (org-map-entries #'org-fold-hide-subtree
                        "+TODO=\"DONE\"|+TODO=\"N/A\"" 'file 'archive 'comment))
   #+end_src
...
** Agenda
   ...
   #+begin_src emacs-lisp
     ...
     ;; use AM/PM timestamps in agenda as opposed to 24-hr timestamps
              ...
              ((agenda "" ((org-agenda-span 'day)))
               ...
               (tags "CATEGORY=\"inbox\""
                     ((org-agenda-overriding-header "Inbox")
                      (org-agenda-files '("/Users/kaiyang/org/agenda/inbox.org"))))
               (todo "NEXT"
...
** Key Bindings
   ...
   #+begin_src emacs-lisp
     ...
     (global-set-key (kbd "C-c f") 'ky/org-hide-done-entries-in-buffer)
...
** Org-Journal
   ...
   #+begin_src emacs-lisp
     ...
     (use-package org-journal
       :custom
       (org-journal-dir "/Users/kaiyang/org/journal")
...
** Deft
   ...
   #+begin_src emacs-lisp
     (use-package deft
       :custom
       (deft-directory "/Users/kaiyang/org/notes")
       (deft-extensions '("org"))
